...
if ($userRow['patientMaritialStatus']=='New Patient') {
$newPatient = "checked";
}elseif ($userRow['patientMaritialStatus']=='Old Patient') {
$oldPatient = "checked";
}
?>
<!DOCTYPE html>
                                                    ...
                                                    <table class="table table-user-information">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="radio">
                                                                        <label><input type="radio" name="patientMaritialStatus" value="New Patient" <?php echo $newPatient; ?>>New Patient</label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label><input type="radio" name="patientMaritialStatus" value="Old Patient" <?php echo $oldPatient; ?>>Old Patient</label>
                                                                    </div>
