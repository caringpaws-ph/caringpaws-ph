...
<body>
        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Choose your destination</a></h1>
              <ul>
                <li><a href="./faqsadmin.php"><span>Blog Dashboard</span></a></li>
                <li><a href="./doctoradmin.php"><span>Doctor Dashboard</span></a></li>
  ...
  <script src="jsdashboard/popper.js"></script>
  <script src="jsdashboard/bootstrap.min.js"></script>
  <script src="jsdashboard/main.js"></script>
