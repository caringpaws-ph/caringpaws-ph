...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  //GET THE TITLE BRO
  $_GET['p2'] = 100;
  $dataTitle2 = isset($_POST['dataTitle2']) ? $_POST['dataTitle2'] : header("Location: https://caringpaws-ph.herokuapp.com/index.php" . $_SERVER['REDIRECT_URI'] . '?' . http_build_query($_GET)); 
  $_SESSION['theTitle2'] = $dataTitle2;

  $sql5 = "SELECT idBlogger, Behavior, Message FROM behavior WHERE Behavior='" . $_SESSION['theTitle2'] . "'";
  ...
  //COMPARE BEHAVIOR ID BLOGGER AND BLOGGER BLOGGERID
  $sql4 = "SELECT blogger.bloggerId, behavior.idBlogger FROM blogger, behavior WHERE blogger.bloggerId = behavior.idBlogger"; //sql code 
            ...
            <div class="row">
               <div class="col-lg-8 posts-list">
                  ...
                  <div class="comment-form">
                     ...
                     <form class="form-contact comment_form" action="blogmail.php" method="post" id="commentForm">
                        <div class="row">
                           <div class="col-12">
