...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  //GET THE TITLE BRO
  $_GET['p2'] = 100;
  $dataTitle = isset($_POST['dataTitle1']) ? $_POST['dataTitle1'] : header("Location: https://caringpaws-ph.herokuapp.com/index.php" . $_SERVER['REDIRECT_URI'] . '?' . http_build_query($_GET)); 
  $_SESSION['theTitle'] = $dataTitle;


  $sql5 = "SELECT idBlogger, Health, Message FROM health WHERE Health='" . $_SESSION['theTitle']  . "'";
  ...
  //COMPARE HEALTH ID BLOGGER AND BLOGGER BLOGGERID
  $sql4 = "SELECT blogger.bloggerId, health.idBlogger FROM blogger, health WHERE blogger.bloggerId = health.idBlogger"; //sql code 
