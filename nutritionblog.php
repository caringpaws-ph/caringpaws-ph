...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  //GET THE TITLE BRO
  $_GET['p2'] = 100;
  $dataTitle3 = isset($_POST['dataTitle3']) ? $_POST['dataTitle3'] : header("Location: https://caringpaws-ph.herokuapp.com/index.php" . $_SERVER['REDIRECT_URI'] . '?' . http_build_query($_GET)); 
  $_SESSION['theTitle3'] = $dataTitle3;


  $sql5 = "SELECT idBlogger, Nutrition, Message FROM nutrition WHERE Nutrition='" . $_SESSION['theTitle3'] . "'";
  ...
  //COMPARE NUTRITION ID BLOGGER AND BLOGGER BLOGGERID
  $sql4 = "SELECT blogger.bloggerId, nutrition.idBlogger FROM blogger, nutrition WHERE blogger.bloggerId = nutrition.idBlogger"; //sql code 
