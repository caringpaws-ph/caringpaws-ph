...
<html lang="en">
    <head>
        ...
        <title>CaringPaws | Doctor Dashboard</title>
        <!-- Bootstrap Core CSS -->
    ...
    <?php
       if(isset($_SESSION['checker'])){
        ...
        if($checker == 1){
            ...
            <i class="fa fa-info-circle"></i>  <strong>A new patient has booked an appointment!</strong>
            </div>
            </div>';
            // echo $notif;
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading" >
                        <h3 class="panel-title" style="font-weight: bold;">Appointment List</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="IC No." disabled></th>
